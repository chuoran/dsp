...
>> Tuples and lists are both sequence of values that could be of any type and are indexed. Lists are mutable while tuples are not.
  Tuples will work as keys in dictionary, maybe because they are immutable, so they are set once assigned? 
